                  ...
                  Positioned(
                    ...
                    child: InkWell(
                      child: Container(
                        ...
                        child: Center(child: Text('Ar',style: TextStyle(color: controller.isUs.value?Colors.black:Colors.white,fontWeight:controller.isUs.value? FontWeight.normal:FontWeight.bold))),
                      ),
